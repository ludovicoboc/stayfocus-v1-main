...
DROP POLICY IF EXISTS "Users can manage their own atividades_lazer" ON atividades_lazer;
...
DROP POLICY IF EXISTS "Users can manage their own sugestoes_favoritas" ON sugestoes_favoritas;
...
DROP POLICY IF EXISTS "Users can manage their own sessoes_lazer" ON sessoes_lazer;
...
DROP POLICY IF EXISTS "Authenticated users can view sugestoes_descanso" ON sugestoes_descanso;
...
DROP POLICY IF EXISTS "Users can manage their own self knowledge notes" ON self_knowledge_notes;
...
DROP TRIGGER IF EXISTS update_atividades_lazer_updated_at ON update_updated_at_column;
...
DROP TRIGGER IF EXISTS update_self_knowledge_notes_updated_at ON update_updated_at_column;
