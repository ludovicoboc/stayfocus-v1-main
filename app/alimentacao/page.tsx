    ...
    <main className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        <Card className="bg-slate-800 border-slate-700">
          ...
          <CardContent>
            ...
            <Link href="/receitas">
              <Button className="bg-blue-600 hover:bg-blue-700">Acessar Minhas Receitas</Button>
            </Link>
          </CardContent>
        </Card>
        ...
        <div className="text-center py-8">
          <blockquote className="text-slate-400 italic text-sm max-w-2xl mx-auto">
            "Vitalidade é o resultado final, não o ponto de partida. Portanto, não deixe Mãori Tradição: Simplesmente
            mantenha uma mente saudável, seja grato por tudo que você tem, mantenha-se ativo."
          </blockquote>
