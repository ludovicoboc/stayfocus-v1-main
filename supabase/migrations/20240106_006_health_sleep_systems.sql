...
DROP POLICY IF EXISTS "Users can manage their own registros_humor" ON registros_humor;
...
DROP POLICY IF EXISTS "Users can manage their own medicamentos_tomados" ON medicamentos_tomados;
...
DROP POLICY IF EXISTS "Users can manage their own sleep reminders" ON sleep_reminders;
...
DROP TRIGGER IF EXISTS update_medicamentos_updated_at ON update_updated_at_column;
CREATE TRIGGER update_medicamentos_updated_at
    BEFORE UPDATE ON medicamentos
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_registros_humor_updated_at ON update_updated_at_column;
...
DROP TRIGGER IF EXISTS update_sleep_records_updated_at ON update_updated_at_column;
CREATE TRIGGER update_sleep_records_updated_at 
    BEFORE UPDATE ON sleep_records 
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_sleep_reminders_updated_at ON update_updated_at_column;
...
DROP TRIGGER IF EXISTS validate_sleep_record_data ON validate_sleep_times;
...
DROP TRIGGER IF EXISTS on_auth_user_created_sleep_setup ON handle_new_user_sleep_setup;
