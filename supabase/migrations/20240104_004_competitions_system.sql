...
DROP POLICY IF EXISTS "Users can manage subjects from their competitions" ON competition_subjects;
...
DROP POLICY IF EXISTS "Users can manage topics from their competition subjects" ON competition_topics;
...
DROP POLICY IF EXISTS "Users can manage questions from their competitions" ON competition_questions;
...
DROP POLICY IF EXISTS "Users can manage their own simulations" ON competition_simulations;
...
DROP POLICY IF EXISTS "Users can manage their own simulation history" ON simulation_history;
...
DROP TRIGGER IF EXISTS update_competitions_updated_at ON update_updated_at_column;
CREATE TRIGGER update_competitions_updated_at
    BEFORE UPDATE ON competitions
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_competition_subjects_updated_at ON update_updated_at_column;
CREATE TRIGGER update_competition_subjects_updated_at
    BEFORE UPDATE ON competition_subjects
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_competition_topics_updated_at ON update_updated_at_column;
CREATE TRIGGER update_competition_topics_updated_at
    BEFORE UPDATE ON competition_topics
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_competition_questions_updated_at ON update_updated_at_column;
CREATE TRIGGER update_competition_questions_updated_at
    BEFORE UPDATE ON competition_questions
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_competition_simulations_updated_at ON update_updated_at_column;
CREATE TRIGGER update_competition_simulations_updated_at
    BEFORE UPDATE ON competition_simulations
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_simulation_history_updated_at ON update_updated_at_column;
