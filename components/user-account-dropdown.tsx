...
export function UserAccountDropdown({ children }: UserAccountDropdownProps) {
  ...
  if (!user) {
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent 
          align="end" 
          className="w-64 sm:w-72 max-w-[calc(100vw-2rem)]"
          sideOffset={8}
        >
          <DropdownMenuLabel>
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent 
        align="end" 
        className="w-72 sm:w-80 md:w-96 max-w-[calc(100vw-2rem)]"
        sideOffset={8}
      >
        ...
        <DropdownMenuItem onClick={handleNavigateToProfile} className="p-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground">Informações pessoais e configurações</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>

        {/* Account Settings */}
        <DropdownMenuItem onClick={() => router.push("/perfil#configuracoes")} className="p-3">
          <Settings className="mr-3 h-4 w-4 text-gray-600" />
          <div className="flex flex-col">
            <span className="text-sm font-medium">Configurações da Conta</span>
            <span className="text-xs text-muted-foreground">Segurança, privacidade e notificações</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>

        <DropdownMenuItem onClick={() => handleQuickAction('privacy')} className="p-3">
          <Shield className="mr-3 h-4 w-4 text-red-600" />
          <div className="flex flex-col">
            <span className="text-sm font-medium">Privacidade e Segurança</span>
            <span className="text-xs text-muted-foreground">Controle de dados e segurança</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>
        ...
        <DropdownMenuItem onClick={() => router.push("/perfil#metas")} className="p-3">
          <Target className="mr-3 h-4 w-4 text-green-600" />
          <div className="flex flex-col">
            <span className="text-sm font-medium">Metas Diárias</span>
            <span className="text-xs text-muted-foreground">Configurar objetivos pessoais</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>

        <DropdownMenuItem onClick={() => router.push("/perfil#preferencias")} className="p-3">
          <Eye className="mr-3 h-4 w-4 text-purple-600" />
          <div className="flex flex-col">
            <span className="text-sm font-medium">Preferências Visuais</span>
            <span className="text-xs text-muted-foreground">Alto contraste, texto grande</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>
        ...
        <DropdownMenuItem onClick={() => router.push("/")} className="p-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground">Progresso e relatórios</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>
        ...
        {/* Data Management */}
        <DropdownMenuItem onClick={() => router.push("/perfil#backup")} className="p-3">
          <Download className="mr-3 h-4 w-4 text-indigo-600" />
          <div className="flex flex-col">
            <span className="text-sm font-medium">Backup e Dados</span>
            <span className="text-xs text-muted-foreground">Exportar/importar configurações</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>
        ...
        <DropdownMenuItem onClick={handleNavigateToHelp} className="p-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground">Documentação e contato</span>
          </div>
          <ChevronRight className="ml-auto h-4 w-4" />
        </DropdownMenuItem>
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-sm font-medium">{isSigningOut ? "Saindo..." : "Sair da Conta"}</span>
