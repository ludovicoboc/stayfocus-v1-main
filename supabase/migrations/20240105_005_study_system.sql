...
DROP TRIGGER IF EXISTS update_study_sessions_updated_at ON update_updated_at_column;
...
DROP TRIGGER IF EXISTS update_pomodoro_sessions_updated_at ON update_updated_at_column;
...
DROP TRIGGER IF EXISTS sync_pomodoro_cycles_trigger ON sync_pomodoro_cycles;
